...
class MeeShapePredictor():
    ...
    def find_keypoints(self, img, speed_transform=True):
        self.results = []
...
def main():
    ...
    pTime = 0
    detector = MeeShapePredictor(predictor_path='../mee_shape_predictor_68_face_landmarks.dat')
    ...
    while True:
        ...
        results = detector.find_keypoints(img)
        detector.draw_keypoints(img)
